...
const BrandsSection = () => {
  ...
  const brands = [
    { name: 'GM', logo: 'logo-gm.png' },
    { name: 'New Balance', logo: 'New_Balance_logo.svg.png' },
    { name: 'Nike', logo: 'Logo_NIKE.svg' },
    { name: 'Adidas', logo: 'Adidas_Logo.svg' },
    { name: 'Puma', logo: 'Puma_complete_logo.svg.png' },
    { name: 'Reebok', logo: 'reeboklogo.png' },
    { name: 'ASICS', logo: 'vs.png' },
  ];
